...
class IconToastWidget extends StatefulWidget {
  ...
  factory IconToastWidget.fail({String msg, Color backgroundColor}) =>
      IconToastWidget(
        message: msg,
        icon: Icon(
          Icons.close,
  ...
  factory IconToastWidget.success({String msg, Color backgroundColor}) =>
      IconToastWidget(
        message: msg,
        icon: Icon(
          Icons.done,
    ...
    Widget content = Material(
      ...
      child: Container(
          ...
          padding: widget.padding ??
              EdgeInsets.symmetric(vertical: 10.0, horizontal: 17.0),
